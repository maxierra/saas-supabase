    ...
    <div className="min-h-screen bg-gray-100 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto">
        <div className="bg-white shadow rounded-lg p-6">
          <h1 className="text-2xl font-bold mb-6">Prueba de Pago con MercadoPago</h1>
          ...
          {loading ? (
            ...
            <>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="p-4 border rounded">
                  ...
                  <ul className="mb-4 text-sm">
                    <li className="flex items-center mb-2">
                      <span className="text-green-500 mr-2">✓</span> Acceso a todas las funciones
                    </li>
                    <li className="flex items-center mb-2">
                      <span className="text-green-500 mr-2">✓</span> Soporte técnico
                    </li>
                  </ul>
                  <BasicPaymentButton 
                    plan="monthly" 
                ...
                <div className="p-4 border rounded border-blue-200 bg-blue-50 relative">
                  <div className="absolute top-0 right-0 bg-blue-500 text-white text-xs px-2 py-1 rounded-bl">Recomendado</div>
                  ...
                  <ul className="mb-4 text-sm">
                    ...
                    <li className="flex items-center mb-2">
                      <span className="text-green-500 mr-2">✓</span> Soporte técnico prioritario
                    </li>
                    <li className="flex items-center mb-2">
                      <span className="text-green-500 mr-2">✓</span> Ahorro del 16.7%
                    </li>
                  </ul>
                  <BasicPaymentButton 
                    plan="annual" 
