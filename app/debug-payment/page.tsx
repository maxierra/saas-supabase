...
export default function DebugPaymentPage() {
  ...
  const checkCredentials = async () => {
    try {
      const response = await fetch('/api/mercadopago/check-credentials');
      const data = await response.json();
    ...
    <div className="min-h-screen bg-gray-100 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-5xl mx-auto">
        <div className="bg-white shadow rounded-lg p-6">
          <h1 className="text-2xl font-bold mb-6">Depuración de Pagos con MercadoPago</h1>
          ...
          <div className="mb-8">
            ...
            {paymentInfo && (
              <div className="mt-4">
                <h3 className="font-medium mb-2">Respuesta de MercadoPago</h3>
                <pre className="bg-gray-100 p-3 rounded text-sm overflow-x-auto">
          ...
          <div className="mt-8 p-4 bg-yellow-50 border border-yellow-200 rounded">
            ...
            <ol className="list-decimal pl-5 text-sm text-yellow-700 space-y-2">
              ...
              <li>Prueba crear un pago y observa la respuesta de MercadoPago.</li>
          ...
          <div className="mt-8 p-4 bg-red-50 border border-red-200 rounded">
            ...
            <p className="text-sm text-red-700 mb-4">
              Se ha detectado que el token de acceso de MercadoPago no es válido o ha expirado. Para solucionar este problema:
            </p>
            <ol className="list-decimal pl-5 text-sm text-red-700 space-y-2">
              <li><strong>Verifica tus credenciales de MercadoPago:</strong> Accede a tu cuenta de MercadoPago y asegúrate de tener las credenciales correctas.</li>
              <li><strong>Actualiza el archivo .env.local:</strong> Asegúrate de que las variables MERCADOPAGO_ACCESS_TOKEN y NEXT_PUBLIC_MERCADOPAGO_PUBLIC_KEY estén correctamente configuradas.</li>
              ...
              <li><strong>Usa credenciales de producción para usuarios de prueba:</strong> MercadoPago recomienda usar credenciales de producción con usuarios de prueba, no credenciales de prueba.</li>
            </ol>
          </div>
        </div>
      </div>
